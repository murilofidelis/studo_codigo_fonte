...
public class MatriculaService {
    ...
    private String geraMatricula(Matricula matricula) {
        ...
        return new StringBuilder().append(ano).append("/").append(matricula.getTurma().getSerie().substring(0, 1)).append("/").append(matricula.getTurma().getDescricaoTurma()).append("/").append(matricula.getAluno().getCodigo()).toString();
    }
