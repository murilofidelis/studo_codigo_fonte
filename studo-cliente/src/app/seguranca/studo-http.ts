...
@Injectable()
export class StudoHttp extends AuthHttp {
  ...
  /** método responsável por verificar se o token access token esta expirado e renovar o mesmo antes de cada requisição */
  private fazerRequisicao(funcao: Function): Observable<Response> {

    if (this.auth.isAccessTokenInvalido()) {
      const chamadaNovoAccessToken = this.auth.novoAccessToken()
        .then(() => {
